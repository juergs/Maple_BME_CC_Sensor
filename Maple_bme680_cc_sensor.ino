...
//--- OLED 128x64 SSD1306.
#define I2C_ADDRESS_OLED    0x3C      //OLED

/* Sensor Config */
#define VERSION             "V1.5"
#define NODEID              7        // was 6, every node needs his own unique ID 
...
#define LEDpin              LED_BUILTIN       // BUILTIN_LED, auto or set pin of your choice (PB1 is Maple specific) 
  ...
  /* OLED display */
  #define OLED_ADR           0x3C;  // 0x3C //set I2C adress 0x3C or 0x3D
  bool    OLED =                1;  // [0/1] 1 = activates the OLED display (SH1106 or SSD1306)
...
// --- Tiefpassfilter over 6 readings 
movingAvg IAQ_QUER; 
                  ...
                  float pressure, float raw_temperature, float raw_humidity, float gas, bsec_library_return_t bsec_status)
{
      ...
      float vdd = 3.3;    //TODO: for Maple     ESP.getVcc() / 1000;
...
void setup()
{
    ...
    digitalWrite(LEDpin, LOW); //LED is low activ !
    ...
    {
      /* init OLED */
      //display.begin(SSD1306_SWITCHCAPVCC, 0x3C); // initialize VCC state, I2C addr 0x3C / 0x3D
      display.begin(&Adafruit128x64, I2C_ADDRESS_OLED);
      //display.set400kHz();   // presettet by Wire
